            ...
            <div>
                    ...
                    <Row>
                        <Col md={12} sm={24} xs={24} className={styles.colHalf}>
                            ...
                            <p className={styles.descTDEE}>
                                <b>TDEE (Total Daily Energy Expenditure)</b>
                                nghĩa là lượng calo bạn sẽ đốt cháy trong 1
                                ngày, bao gồm cả ăn chơi ngủ nghỉ và tập luyện.
                            </p>
                            <p className={styles.descTDEE}>
                                TDEE rất quan trọng trong việc giảm cân hay tăng
                                cân hay tăng cơ vì nó giúp ta biết nên tiêu thụ
                                bao nhiêu calo là đủ Công thức tính rất đơn giản
                        ...
                        <div className="marquee-w">
                            <div className="marquee">
                                <span className="textyyy">
                                    Your pleasure is our honor
                                </span>
                            </div>
                        ...
                        <div style={{ marginTop: "-4%", display: "flex" }}>
                            <div style={{ width: "50%", paddingLeft: "40%" }}>
                                <h3 className={styles.HomePageTitleContent}>
                                    FITNESS HEALTH
                                </h3>
                ...
                <h3 className={styles.HomePageDescContent}>
                  ĐỂ CHĂM SÓC SỨC KHỎE CỦA BẠN
                                ...
                                <h3 className={styles.HomePageDescContent}>
                                    CUNG CẤP CÁCH TỐT HƠN ĐỂ CHĂM SÓC SỨC KHỎE
                                    CỦA BẠN
                                </h3>
                            </div>
                            <div style={{ width: "50%" }}>
