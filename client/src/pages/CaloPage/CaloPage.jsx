...
const CaloPage = () => {
    ...
    const handleDelete = (key) => {
        ...
        const p =
            totalprotein -
            (Number(deleteProduct[0].protein) *
                Number(deleteProduct[0].quantity)) /
                100;
        const c =
            totalcarb -
            (Number(deleteProduct[0].carb) *
                Number(deleteProduct[0].quantity)) /
                100;
        const f =
            totalfat -
            (Number(deleteProduct[0].fat) * Number(deleteProduct[0].quantity)) /
                100;
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (calo, quantity) => (
                <p>{(+calo * +quantity.quantity) / 100}</p>
            ),
        },
        {
            title: "Protein",
        ...
        },
        {
            ...
            render: (carb, quantity) => (
                <p>{(+carb * +quantity.quantity) / 100}</p>
            ),
        },
        {
            title: "Chất Béo",
