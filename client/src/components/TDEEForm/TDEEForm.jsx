    ...
    >
      ...
      <Form.Item>
        ...
        >
          ...
          Chỉ số BMI của bạn là <b>{parseFloat(bmi.toFixed(1))}</b>, bạn đang{" "}
          <b>{bmirange}</b>
          <p style={{ lineHeight: "2" }}>
            {" "}
            Để duy trì cân nặng, hãy ăn <b>{tdeevalue}</b> calo mỗi ngày.
          </p>
          <p style={{ lineHeight: "2" }}>
            Để tăng 0,45 kg / tuần, hãy ăn <b>{tdeevalue + 500}</b> calo mỗi
            ngày.
          </p>
          <p style={{ lineHeight: "2" }}>
            Để tăng 0,9 kg / tuần, hãy ăn <b>{tdeevalue + 100}</b> calo mỗi
            ngày.
          </p>
          <p style={{ lineHeight: "2" }}>
            Để giảm 0,45 kg / tuần, hãy ăn <b>{tdeevalue - 500}</b> calo mỗi
            ngày.
          </p>
          <p style={{ lineHeight: "2" }}>
            Để giảm 0,9 kg / tuần, hãy ăn <b>{tdeevalue - 100}</b> calo mỗi
            ngày.
          </p>
        </Modal>
      </Form.Item>
